...
//REVIEW we are not storing the promise we are directly conusming it inline !
new Promise(function (resolve, reject) {
  ...
  console.log("Async 2 resolved"); //REVIEW  Runs only because resolve() was called
});

//REVIEW When the Promise is fulfilled (i.e., resolve() is called), the value passed to resolve() (the object { username: "Chai", email: "chai@example.com" }) is passed to the .then() callback as the user parameter.
