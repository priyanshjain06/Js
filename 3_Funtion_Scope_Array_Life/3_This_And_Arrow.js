...
//   console.log(this.username); // logs undefined because username is not a property of the global object
// }
// chai();
...
function chai(){
  let username = "hitesh";
  console.log(this); // returns undefined because strict mode logs the global object (window in browsers)  
